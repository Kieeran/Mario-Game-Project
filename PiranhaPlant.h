...
#define RED_PIRANHA_PLANT_RISEUP_SPEED		0.04f
#define GREEN_PIRANHA_PLANT_RISEUP_SPEED		0.03f

#define RED_FIRE_PIRANHA_PLANT_RISEUP_HEIGHT_MAX		41.0f
#define GREEN_FIRE_PIRANHA_PLANT_RISEUP_HEIGHT_MAX		33.0f
